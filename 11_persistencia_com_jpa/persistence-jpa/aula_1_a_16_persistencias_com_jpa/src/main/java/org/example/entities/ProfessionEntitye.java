...
@Table(name = "profession") /*referenciando tabela com o nome "Peoples"*/
public class ProfessionEntitye {
    ...
    public ProfessionEntitye(){

    }

    public ProfessionEntitye(String nome) {
        this.name = nome;
    }
